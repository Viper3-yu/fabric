...
基于 [Viper3-yu/fabric](https://github.com/Viper3-yu/fabric)，增加 GIS 运输控制塔、双组织交接、物流单元展示及数据源设置，保留原项目业务流程和提交历史。
...
本仓库不包含 Fabric 证书/私钥、`.env`、数据库运行数据或依赖安装目录。下文为原项目使用说明；运行集成版请先阅读上方集成说明。
