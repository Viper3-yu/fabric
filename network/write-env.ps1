...
# without sharing one secret across machines. Replace it for any real
# deployment (the file is regenerated by every network start).
# RandomNumberGenerator::Fill is .NET 6+; Windows PowerShell 5.1 needs Create().
